...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarize(ap=1, iouThr=None, areaRng='all', maxDets=100):
            category_names = ["Lighter", "Knife", "Wrench", "Pliers", "Scissors", "Powerbank"]
            name = {}
            p = self.params
            ...
            if s.shape[category_dimension] > 1:
                ...
                per_category_mean_s = np.round(per_category_mean_s, decimals=3)
                name = dict(zip(category_names, per_category_mean_s))

                with np.printoptions(precision=3, suppress=True, sign=" ", floatmode="fixed"):
                    print(iStr.format(titleStr, typeStr, iouStr, areaRng, maxDets, mean_s, name))
            else:
